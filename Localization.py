...
langs = {
    'zh_CN': {
        ...
        ('Operator', 'New '+get_vertex_color_label()): '新建顶点色 (New '+get_vertex_color_label()+')',
        ('Operator', 'Open Available '+get_vertex_color_label()): '打开现有顶点色',
        ('Operator', 'Use Available '+get_vertex_color_label()): '使用现有顶点色',
        ('Operator', 'New '+get_vertex_color_label()+' Mask'): '新建顶点色遮罩',
        ('Operator', 'Open Available '+get_vertex_color_label()+' as Mask'): '使用现有顶点色为遮罩',
        ...
        ('*', 'Image Mask:'): '图像遮罩:',
        ('*', get_vertex_color_label()+' Mask:'): '顶点色遮罩:',
        ('Operator', get_vertex_color_label()): '顶点色 ('+get_vertex_color_label()+')',
        ...
        ('Operator', 'Solid Color w/ '+get_vertex_color_label()+' Mask'): '实色 / 顶点色遮罩',
        ('Operator', 'Solid Color w/ Color ID Mask'): '实色 / 颜色 ID 遮罩',
        ('Operator', 'Background w/ Image Mask'): '背景 / 图像遮罩',
        ('Operator', 'Background w/ '+get_vertex_color_label()+' Mask'): '背景 / 顶点色遮罩',
        ('Operator', 'Bake Channel to '+get_vertex_color_label()+' (Batch All Materials)'): '烘焙通道至顶点色 (批处理所有材质)',
        ('Operator', 'Bake Channel to '+get_vertex_color_label()): '烘焙通道至顶点色',
        ...
        ('Operator', 'White'): '白色',
        ('Operator', 'Black'): '黑色',
        ('*', 'Fill selected polygon with '+get_vertex_color_label(00)): '填充选定多边形顶点色',
        ('*', 'Fill selected polygon with '+get_vertex_color_label(00)+' with custom color'): '填充选定多边形自定义顶点色',
        ('*', 'Fill Color ID'): '填充颜色 ID',
        ('*', 'Number of Images: '): '图像数量: ',
        ('*', 'Number of '+get_vertex_color_label()+'s: '): '顶点色数量: ',
    ...
    'ar': {
        ...
        ('*', get_vertex_color_label()+' Mask:'): 'طﺎﻘﻨﻟا ﻦﻳﻮﻠﺗ عﺎﻨﻗ:',
        ...
        ('*', 'Connect To:'): 'ـﻟ ﻞﻴﺻﻮﺗ:',
        ('*', 'Fill '): 'ﺊﻠﻣ ',
        ('*', 'Fill selected polygon with '+get_vertex_color_label(00)): 'طﺎﻘﻨﻟا نﻮﻠﺑ ةدﺪﺤﻤﻟا تﺎﻌﻠﻀﻤﻟا ﺊﻠﻣ',
        ('*', 'Fill selected polygon with '+get_vertex_color_label(00)+' with custom color'): 'ﺺﺼﺨﻣ نﻮﻟ ﻊﻣ طﺎﻘﻨﻟا نﻮﻠﺑ ةدﺪﺤﻤﻟا تﺎﻌﻠﻀﻤﻟا ﺊﻠﻣ',
        ('*', 'Fill Color ID'): 'نﻮﻠﻟا فﺮﻌﻣ ﺊﻠﻣ',
        ('*', 'Number of Images: '): 'رﻮﺼﻟا دﺪﻋ: ',
        ('*', 'Number of '+get_vertex_color_label()+'s: '): 'طﺎﻘﻨﻟا ناﻮﻟأ دﺪﻋ: ',
        ...
        ('Operator', 'New '+get_vertex_color_label()): 'ﺪﻳﺪﺟ طﺎﻘﻧ نﻮﻟ',
        ('Operator', 'Open Available '+get_vertex_color_label()): 'ﺔﺣﺎﺘﻤﻟا طﺎﻘﻨﻟا ناﻮﻟأ ﺢﺘﻓ',
        ('Operator', 'Use Available '+get_vertex_color_label()): 'ﺔﺣﺎﺘﻤﻟا طﺎﻘﻨﻟا ناﻮﻟأ مﺪﺨﺘﺳا',
        ('Operator', 'New '+get_vertex_color_label()+' Mask'): 'ﺪﻳﺪﺟ طﺎﻘﻧ ناﻮﻟأ عﺎﻨﻗ',
        ('Operator', 'Open Available '+get_vertex_color_label()+' as Mask'): 'عﺎﻨﻘﻛ ﺔﺣﺎﺘﻤﻟا طﺎﻘﻨﻟا ناﻮﻟأ ﺢﺘﻓ',
        ...
        ('Operator', get_vertex_color_label()): 'طﺎﻘﻨﻟا ﻦﻳﻮﻠﺗ',
        ('Operator', 'Image'): 'ةرﻮﺻ',
        ...
        ('Operator', 'Solid Color w/ '+get_vertex_color_label()+' Mask'): 'طﺎﻘﻨﻟا نﻮﻟ عﺎﻨﻗ ﻊﻣ ﻲﻓﺎﺻ نﻮﻟ',
        ('Operator', 'Solid Color w/ Color ID Mask'): 'نﻮﻠﻟا فﺮﻌﻣ عﺎﻨﻗ ﻊﻣ ﻲﻓﺎﺻ نﻮﻟ',
        ('Operator', 'Background w/ Image Mask'): 'ةرﻮﺻ عﺎﻨﻗ ﻊﻣ ﺔﻴﻔﻠﺧ',
        ('Operator', 'Background w/ '+get_vertex_color_label()+' Mask'): 'طﺎﻘﻨﻟا نﻮﻟ عﺎﻨﻗ ﻊﻣ ﺔﻴﻔﻠﺧ',
        ('Operator', 'Bake Channel to '+get_vertex_color_label()+' (Batch All Materials)'): '(داﻮﻤﻟا ﻊﻴﻤﺟ ﺔﻌﻓد) طﺎﻘﻨﻟا نﻮﻠﻟ ةﺎﻨﻘﻟا ﻂﻔﺣ',
        ('Operator', 'Bake Channel to '+get_vertex_color_label()): 'طﺎﻘﻨﻟا نﻮﻠﻟ ةﺎﻨﻘﻟا ﻂﻔﺣ',
