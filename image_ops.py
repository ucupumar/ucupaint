...
class YInvertImage(bpy.types.Operator):
    """Invert Image"""
    bl_idname = "material.y_invert_image"
...
class YRefreshImage(bpy.types.Operator):
    """Reload Image"""
    bl_idname = "material.y_reload_image"
...
class YPackImage(bpy.types.Operator):
    """Pack Image"""
    bl_idname = "material.y_pack_image"
    bl_label = "Pack Image"
    bl_options = {'REGISTER', 'UNDO'}
...
class YSaveImage(bpy.types.Operator):
    """Save Image"""
    bl_idname = "material.y_save_image"
    bl_label = "Save Image"
    bl_options = {'REGISTER', 'UNDO'}
...
class YSaveAllBakedImages(bpy.types.Operator):
    ...
    bl_idname = "material.y_save_all_baked_images"
...
class YSaveAsImage(bpy.types.Operator, ExportHelper):
    """Save As Image"""
    bl_idname = "material.y_save_as_image"
...
class YSavePackAll(bpy.types.Operator):
    ...
    bl_idname = "material.y_save_pack_all"
