...
# - Bake will throw error if there's no unwrapped object using same material
# - Bake will throw error if there's object using same material with render/view turned off
#
# KNOWN ISSUES:
